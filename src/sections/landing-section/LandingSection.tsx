  ...
  return (
    <ScrollSnapWrapper>
      ...
      <Container>
        ...
        <p className="name__text"> chijioke.</p>
        <p style={{ width: "50%", marginBottom: "2rem", opacity: 0.7 }}>
          I am a{" "}
          <StyledSpanTags>
            Client-Side focused Software Engineer {"  "}
          </StyledSpanTags>
          (Core Typescript) currently based in{" "}
          <StyledSpanTags>Abuja, Nigeria.</StyledSpanTags> <br></br>Currently, I am focused on 
          creatively solving problems and I am open to collaborating on{" "}
          <StyledSpanTags>freelance and open source projects.</StyledSpanTags>
        </p>
        <button style={{ width: "fit-content", zIndex: "900" }}>
          {" "}
          Get In Touch
        </button>
      </Container>
